...
if __name__ == "__main__":
    ...
    if args.model.startswith("VGG16"):
        T = VGG16(1000)
        path_T = '../checkpoint/VGG16_88.26.tar'
    elif args.model.startswith('IR152'):
        T = IR152(1000)
        path_T = '../checkpoint/IR152_91.16.tar'
    elif args.model == "FaceNet64":
        T = FaceNet64(1000)
        path_T = '../checkpoint/FaceNet64_88.50.tar'
    ...
    for i in range(1):
        ...
        for idx in range(10):
            ...
            if args.dist_flag == True:
                acc, acc5 = dist_inversion(G, D, T, E, iden, itr=i, lr=2e-2, momentum=0.9, lamda=100, iter_times=300, clip_range=1, improved=args.improved_flag, num_seeds=1)
            else:
                acc, acc5 = inversion(G, D, T, E, iden, itr=i, lr=2e-2, momentum=0.9, lamda=100, iter_times=300, clip_range=1, improved=args.improved_flag, num_seeds=1)
