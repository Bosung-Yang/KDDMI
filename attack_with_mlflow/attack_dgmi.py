...
import os, logging
import numpy as np
from attack import inversion, dist_inversion, deactivate_inversion
    ...
    for i in range(1):
        ...
        for idx in range(6):
            ...
            if args.dist_flag == True:
                ...
                acc, acc_5, acc_var, acc_var5, acc_list, acc5_list = deactivate_inversion(G, D, T, E, iden, itr=i, lr=2e-2, momentum=0.9, lamda=100, iter_times=iter_times, clip_range=1, improved=args.improved_flag, num_seeds=1, exp_name=args.exp)
